...
# Response parsing lives in its own dependency-free module (testable without
# openai/chromadb); re-exported here for existing callers.
from .conversation_manager_parsing import (  # noqa: F401
    _SLOW_INTENTS,
    _SURROUNDING_QUOTES,
    _parse_llm_json,
    apply_speech_tags,
