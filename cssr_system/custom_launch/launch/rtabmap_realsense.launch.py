...
def launch_setup(context, *args, **kwargs):      
    ...
    return [
        ...
        Node(
            ...
            #     }],
            #     remappings=[
            #         ('imu/data_raw', '/camera/imu'),           # Remove the leading /
            #         ('imu/data', '/camera/imu/filtered')       # Remove the leading /
            #     ],
            #     namespace=LaunchConfiguration('namespace')
            # ),
        ]
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('approx_sync_max_interval',  default_value='0.3', description='(sec) 0 means infinite interval duration (used with approx_sync=true)'),

        # RGB-D related topics
        DeclareLaunchArgument('rgb_topic',           default_value='/camera/color/image_raw',       description=''),
        DeclareLaunchArgument('depth_topic',         default_value='/camera/aligned_depth_to_color/image_raw', description=''),
