...
*
* Author: Muhammed Danso and Yohannes Haile
...
extern double mutual_gaze_person_pitch;
extern double mutual_gaze_person_yaw;
...
extern bool face_within_range;                                                  // Stores the status of face within range
