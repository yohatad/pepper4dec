...
//
// Converts relative odometry readings into an absolute robot pose using a
// fixed initial position as the anchor. The first odometry reading received
// after activation is captured as the odom-frame anchor; subsequent readings
// are transformed (translated and rotated) into the global frame relative to
// that anchor and the configured initial pose.
//=============================================================================
