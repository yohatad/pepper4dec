 ...
 * Python package (supervision.tracker.byte_tracker), used by YOLOv11Node to
 * assign persistent track IDs to per-frame detections. Reproduces the
...
#ifndef PERSON_DETECTION_BYTE_TRACKER_H
#define PERSON_DETECTION_BYTE_TRACKER_H
...
#endif  // PERSON_DETECTION_BYTE_TRACKER_H
