...
class MiVOLONode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('face_topic', '/face_detection/data')
        self.declare_parameter('person_topic', '/person_detection/data')
        self.declare_parameter('image_topic', '/camera/color/image_raw')
        self.declare_parameter('output_topic', '/face_detection/age_gender_results')
